...
export BRAVE_COUNTRY="$(bashio::config 'brave_country')"
export BRAVE_SEARCH_LANG="$(bashio::config 'brave_search_lang')"
export BRAVE_RESULT_COUNT="$(bashio::config 'brave_result_count')"
...
echo "BRAVE_COUNTRY=${BRAVE_COUNTRY}"
echo "BRAVE_SEARCH_LANG=${BRAVE_SEARCH_LANG}"
echo "BRAVE_RESULT_COUNT=${BRAVE_RESULT_COUNT}"
