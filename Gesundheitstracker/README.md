...
- Rollback auf Version 2.4.14 vor der Apple-Watch/Quick-API-Erweiterung
...
- Backup-Texte angepasst
- Export heißt jetzt „Backup erstellen“
- Import/Wiederherstellung heißt jetzt „Backup wiederherstellen“


## Änderungen in 2.2.8

- Verbliebenen Text „Export herunterladen“ gezielt in „Backup erstellen“ geändert


## Änderungen in 2.2.9

- Einträge in der Tagesübersicht können jetzt direkt bearbeitet werden
- Neben angezeigten Tagesübersicht-Zeilen erscheint ein kleiner Bearbeiten-Button
- Betrifft Medikamente, Essen, Schlaf, Windel/Toilette und Notizen
- Die Detailansicht bleibt zusätzlich unverändert nutzbar


## Änderungen in 2.3.0

- Bearbeiten-Button in der Tagesübersicht öffnet jetzt ein kleines feldspezifisches Popup
- Schlaf öffnet nur Schlaf
- Essen öffnet nur Essen
- Medikamente öffnet nur Medikamente
- Windel/Toilette öffnet nur Windel/Toilette
- Notizen öffnet nur Notizen
- Das vollständige Bearbeiten über Details bleibt weiterhin verfügbar


## Änderungen in 2.3.1

- Symptom-Tags unter den Tageskacheln zeigen jetzt auch die Intensität an
- Beispiel: `Husten · mittel` oder bei mehreren Einträgen `Husten ×2 · leicht/stark`


## Änderungen in 2.3.2

- Im feldspezifischen Bearbeiten-Popup gibt es jetzt neben „Speichern“ auch einen „Löschen“ Button
- Der Löschen-Button löscht den zugehörigen Eintrag nach Bestätigung


## Änderungen in 2.3.3

- Symptom-Intensität unter den Tageskacheln wird jetzt in Klammern angezeigt
- Beispiel: `Husten (mittel)` statt `Husten · mittel`


## Änderungen in 2.3.4

- Detailansicht optisch überarbeitet
- Werte werden jetzt als kleine Karten mit Icons angezeigt
- Kopfbereich mit Uhrzeit/Datum wurde aufgeräumt
- Bearbeiten/Löschen Buttons in der Detailansicht wurden kompakter gestaltet
- Symptome und Historie sind optisch besser eingebettet


## Änderungen in 2.3.6

- Detailansicht komplett neu als Journal-/Timeline-Ansicht umgesetzt
- Der vorherige Listenansatz aus 2.3.5 wurde verworfen
- Uhrzeit/Datum oben klarer, Bearbeiten/Löschen als kleine Iconbuttons
- Temperatur, Flüssigkeit und Stimmung als kompakte Metriken
- Symptome und weitere Angaben als eigene Abschnitte
- Historie bleibt integriert, aber optisch zurückhaltender


## Änderungen in 2.3.7

- Historie-Icon oben neben Bearbeiten und Löschen ergänzt
- Klick auf das Historie-Icon öffnet/schließt die Historie des Eintrags
...
- Versionsnummer korrigiert, damit Home Assistant das Update sauber erkennt
- Inhaltlich identisch mit der zuletzt erstellten Detail-Popup-Version


## Änderungen in 2.4.2

- Neben dem Bearbeiten-Button in der Tagesübersicht gibt es jetzt einen Historie-Button
- Der Historie-Button öffnet die Historie genau dieses einen Eintrags als Popup
- Dadurch muss man nicht mehr über die verschachtelte Detailansicht gehen
...
- Stimmung ist wieder als Mehrfachauswahl innerhalb eines Eintrags möglich
- Mehrere Stimmungen werden kommagetrennt gespeichert und angezeigt
- Gilt für das große Neuer-Eintrag-Popup und das kleine Stimmung-Popup
- Aktive Stimmungen zeigen wieder ein Häkchen


## Änderungen in 2.4.6

- Flüssigkeit wird jetzt unter den Tageskacheln als Mehrfachliste angezeigt
- Temperatur/Fieber wird jetzt unter den Tageskacheln als Mehrfachliste angezeigt
- Jeder Flüssigkeits- und Temperatur-Eintrag hat jetzt Historie- und Bearbeiten-Button
- Ältere Flüssigkeits- und Temperaturwerte können dadurch direkt geändert werden


## Änderungen in 2.4.7

- Tageskacheln oben kompakter gemacht
- Kacheln zeigen nur noch die wichtigsten Überblickswerte
...
## Änderungen in 2.4.11

- Kacheln zeigen nicht mehr nur nackte Zahlen
- Beispiele: `2 Stimmungen`, `3 Symptome`, `1 Schlaf`, `2 Notizen`
- Kachelname bleibt zusätzlich sichtbar


## Änderungen in 2.4.12

- ZIP-Struktur bereinigt
- Der Ordner `Gesundheitstracker` liegt jetzt direkt im ZIP-Root
- Alter äußerer Ordner `kindgesund_ha_addon_v3` wurde entfernt
- Add-on-Name, Slug und Panel-Titel geprüft


## Änderungen in 2.4.13

- Repository-Struktur repariert
- `repository.yaml` im ZIP-Root ergänzt
- Add-on-Ordner wieder slug-sicher auf `gesundheitstracker` gesetzt, damit Home Assistant das Add-on zuverlässig erkennt
- Anzeigename bleibt „Gesundheitstracker“


## Änderungen in 2.4.14

- Technischen Add-on-Ordner wieder auf `kindgesund` zurückgesetzt
- Technischen Slug wieder auf `kindgesund` zurückgesetzt
- Sichtbarer Name bleibt `Gesundheitstracker`
- Diese Version ist dafür gedacht, dass Home Assistant das bestehende Add-on wiederfindet
