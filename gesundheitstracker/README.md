...
- Rollback auf Version 1.0.0 vor der Apple-Watch/Quick-API-Erweiterung
...
- Komplett neue Add-on-Identität
- Ordner: `gesundheitstracker`
- Slug: `gesundheitstracker`
- Sichtbarer Name: `Gesundheitstracker`
- Unabhängig vom alten `kindgesund`-Add-on
