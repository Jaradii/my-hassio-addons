...
## Änderungen in 1.1.15-test

- Fehler aus 1.1.14 korrigiert: Markierungs-Icon wird nicht mehr über `::before` erzeugt
...
## Änderungen in 1.1.26-test

- Nachkontrolle wird nach dem Beantworten kompakter dargestellt
